...
require_relative '../builder/qris_inquiry'
require 'json'
...
builder = QrisInquiryBuilder.new
request_body = builder.set_qris_inquiry(
  original_reference_no: "TNICEQR08108202507071351066845",
  original_partner_reference_no: "ord2025-07-07T13:51:06+07:00",
...
response = service.send_post_request(endpoints.status_qris, access_token, timestamp, request_body, external_id)
