...
require_relative '../builder/payout_reject'
require 'json'
...
builder = PayoutRejectBuilder.new
request_body = builder.set_payout_reject(
...
response = service.send_post_request(endpoints.reject_payout, access_token, timestamp, request_body, external_id)
