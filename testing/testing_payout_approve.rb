...
require_relative '../builder/payout_approve'
require 'json'
...
builder = PayoutApproveBuilder.new
request_body = builder.set_payout_approve(
...
response = service.send_post_request(endpoints.approve_payout, access_token, timestamp, request_body, external_id)
